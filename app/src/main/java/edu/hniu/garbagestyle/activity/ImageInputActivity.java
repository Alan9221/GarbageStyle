...
import edu.hniu.garbagestyle.adapter.DiscernResultAdapter;
import edu.hniu.garbagestyle.adapter.SearchGoodsAdapter;
import edu.hniu.garbagestyle.contract.ImageContract;
...
import edu.hniu.garbagestyle.utils.Base64Util;
import edu.hniu.garbagestyle.utils.Constant;
import edu.hniu.garbagestyle.utils.FileUtil;
import edu.hniu.garbagestyle.utils.HistoryHelper;
import edu.hniu.garbagestyle.utils.SPUtils;
import edu.hniu.mvplibrary.mvp.MvpActivity;
    ...
    private void turnOnCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            imageUri = FileProvider.getUriForFile(this,
                    "edu.hniu.garbagestyle.fileprovider", outputImage);
        } else {
