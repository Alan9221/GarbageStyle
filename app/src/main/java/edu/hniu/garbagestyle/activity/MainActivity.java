...
import edu.hniu.garbagestyle.adapter.TrashNewsAdapter;
import edu.hniu.garbagestyle.contract.MainContract;
import edu.hniu.garbagestyle.model.TrashNewsResponse;
import edu.hniu.garbagestyle.utils.AppStartUpUtils;
import edu.hniu.garbagestyle.utils.Constant;
import edu.hniu.garbagestyle.utils.NewsHelper;
...
public class MainActivity extends MvpActivity<MainContract.MainPresenter> implements MainContract.MainView {
     ...
     * 进入个人中心页面
     */
    public void jumpMy(View view) {
        gotoActivity(MyselfActivity.class);
    }
